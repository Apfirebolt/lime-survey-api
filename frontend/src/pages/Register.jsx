...
const Register = () => {
  ...
  useEffect(() => {
    // Redirect when registered or logged in
    if (isSuccess || user) {
      navigate("/");
    }
  ...
  return (
    <div className="min-h-[85vh] flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 bg-gray-50 dark:bg-gray-900 transition-colors">
      <div className="max-w-5xl w-full bg-white dark:bg-gray-800 rounded-2xl shadow-xl overflow-hidden grid grid-cols-1 md:grid-cols-2 border border-gray-100 dark:border-gray-700">
        ...
        <div className="hidden md:flex flex-col justify-center items-center p-8 bg-emerald-50 dark:bg-gray-800/80 border-r border-gray-100 dark:border-gray-700/50 text-center">
          ...
          <p className="mt-2 text-sm text-gray-600 dark:text-gray-400 max-w-xs">
            Start creating dynamic surveys, sharing feedback, and gathering real insights today.
          </p>
        </div>
        ...
        <div className="p-8 sm:p-10 flex flex-col justify-center">
          ...
          {isError && (
            <div className="mb-6 p-4 rounded-xl bg-red-50 dark:bg-red-950/40 border border-red-200 dark:border-red-800/50 flex items-center space-x-3 text-red-600 dark:text-red-400 text-sm">
              ...
              <span>{message || "Failed to register account. Please check your details."}</span>
            </div>
          )}
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  type="text"
                  placeholder="John"
                  className={`w-full px-3.5 py-2 rounded-lg border bg-white dark:bg-gray-900 text-gray-900 dark:text-white text-sm focus:outline-none focus:ring-2 transition-all ${
                    errors.firstName
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  placeholder="••••••••"
                  className={`w-full px-3.5 py-2 rounded-lg border bg-white dark:bg-gray-900 text-gray-900 dark:text-white text-sm focus:outline-none focus:ring-2 transition-all pr-12 ${
                    errors.password
                      ? "border-red-500 focus:ring-red-200 dark:focus:ring-red-900"
                      : "border-gray-300 dark:border-gray-600 focus:border-emerald-500 focus:ring-emerald-200 dark:focus:ring-emerald-900/50"
                  }`}
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="w-full mt-2 py-2.5 px-4 rounded-lg bg-emerald-600 hover:bg-emerald-700 dark:bg-emerald-500 dark:hover:bg-emerald-600 text-white font-semibold text-sm shadow-sm hover:shadow transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center"
            >
              {isLoading ? (
